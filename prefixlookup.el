;; prefixlookup.el --- Look up and insert semantic web prefix URIs
;;
;; Version: 1.0
;; Created: 2023-03-04
;;
...
(defun prefixlookup-insert-uri ()
  (interactive)
  (insert
   (cdr(assoc(completing-read "PREFIX:" prefixcc-alist nil t)prefixcc-alist))))
